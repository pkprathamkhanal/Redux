...
class CliqueCoverGraph : UnweightedUndirectedGraph
{
    ...
    public CliqueCoverGraph(string cliqueInput) : base(cliqueInput)
    {
    ...
    public CliqueCoverGraph(string cliqueInput, bool decoy) : base(cliqueInput, decoy)
    {

    }

    public CliqueCoverGraph(List<string> nl, List<KeyValuePair<string, string>> el, int kVal) : base(nl, el, kVal)
    {
