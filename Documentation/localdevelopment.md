...
The C# Dev Kit extension in VSCode generates a solution file named 'project.sln' (i.e. Redux.sln) automatically, therefore the above command fails and returns the following error.
MSBUILD : error MSB1011: Specify which project or solution file to use because this folder contains more than one project or solution file.

To run the above command, rename the solution file (i.e. Redux.sln) to API.sln i.e. similar to your .csproj file name
